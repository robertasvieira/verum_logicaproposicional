...
<body>
    ...
    <div class="content">
        <div class="questoes-container">
            <div class="questoes questao-atual">
                <form id="formRespostas" action="<?= base_url('/fase2') ?>" method="get">
                    <div class="questao" data-id="1" style="display: block;">
                        <h3><strong> Capítulo 1</strong> </h3>
                        <p> A sala está iluminada apenas pelo tênue brilho das lâmpadas antigas. À entrada, você avista um homem de um semblante sério, 
                            reclinado em uma poltrona, distraído com seus próprios pensamentos até notar sua presença.
                            "Entre. Estava à sua espera. Sou o detetive Slughorn," ele o encara, demonstrando grande expectativa e curiosidade. 
                            "Devo admitir que estou intrigado com sua contratação. A lógica proposicional pode, de fato, contribuir nesta investigação?"
                            </p>

                        <input type="hidden" name="id_questao" value="1">
                        <input type="hidden" name="opcao_correta" value="“Sim. A lógica proposicional analisa e manipula proposições para estruturar o pensamento, extraindo conclusões claras ao explorar relações lógicas entre elas”">

                        <button type="button" class="alternativa" onclick="verificarResposta('“Sim. A lógica proposicional analisa e manipula proposições para estruturar o pensamento, extraindo conclusões claras ao explorar relações lógicas entre elas”', this)">
                            “Sim. A lógica proposicional analisa e manipula proposições para estruturar o pensamento, extraindo conclusões claras ao explorar relações lógicas entre elas”
                        </button>

                        <button type="button" class="alternativa" onclick="verificarResposta('“Não vejo como. Em investigações é recomendado confiar mais na intuição, pois um pressentimento é mais valioso do que análises lógicas.”', this)">
                            “Não vejo como. Em investigações é recomendado confiar mais na intuição, pois um pressentimento é mais valioso do que análises lógicas.”
                        </button>

                        <button type="button" class="alternativa" onclick="verificarResposta('“De forma alguma. Lógica proposicional são apenas símbolos complicados que não têm utilidade prática na vida real.”', this)">
                            “De forma alguma. Lógica proposicional são apenas símbolos complicados que não têm utilidade prática na vida real.”
                        </button>
    ...
    <script>
        ...
        function verificarResposta(respostaUsuario) {
            ...
            if (respostaUsuario === '“Sim. A lógica proposicional analisa e manipula proposições para estruturar o pensamento, extraindo conclusões claras ao explorar relações lógicas entre elas”') {
                feedbackMensagem.innerHTML = 'Slughorn expressa sua concordância com um sorriso sutil.';
                btnProsseguir.style.display = 'block';
            } else {
                feedbackMensagem.innerHTML = 'Sua resposta recebe um olhar duvidoso de Slughorn.';
            }
        }
