    ...
    <div class="content">
        <div class="questoes-container">
            <div class="questoes questao-atual">
                <form id="formRespostas" action="<?= base_url('/fase4') ?>" method="get">
                    <div class="questao" data-id="1" style="display: block;">
                        <p> O detetive Slughorn saboreia um gole do seu café, quase esquecido em suas mãos, agora à temperatura morna. 
                            O aroma se espalha pela sala, despertando seus sentidos, quando ele retoma a conversa: "Como essas frases são representadas?"
                        </p>
                        ...
                        “Por meio de variáveis proposicionais, elementos indivisíveis da lógica como
                        p, q, r… p1, p2, p3… e conectivos lógicos, que são símbolos que permitem construir novas fórmulas a partir de outras, 
                        como negação (¬), conjunção (∧), disjunção (∨), condicional (→), bicondicional (↔) e disjunção exclusiva (⊕).”
                        </button>
