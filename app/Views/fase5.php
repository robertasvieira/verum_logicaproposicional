...
<body>
            ...
            <div class="questoes questao-atual">
                <form id="formRespostas" action="<?= base_url('/fase5') ?>" method="get">
                    <div class="questao" data-id="1" style="display: block;">
                        <p> A atmosfera da sala se torna mais gélida, um sinal de que a noite se instalou. 
                            Slughorn, observando o relógio em seu pulso, diz: "É hora de encerrar a investigação por hoje, detetive." </br>
                            Este é apenas o início de um mistério intrigante, no qual você será desafiado a empregar a lógica proposicional 
                            para analisar meticulosamente cada pista descoberta. 
                        </p>
                    </div>
                </form>
            </div>
    ...
    <footer class="w3-center w3-black w3-padding-50" style="position: fixed; bottom: 0; width: 100%;">
